...
function check_pet_ws_timer()
    ...
    if  petWeaponSkillRecast <= 0
        and startedPetWeaponSkillTimer == true
    then
...
function check_pet_ws_equip()
    ...
    if not (state.PetStyleCycle.value:lower() == "spam" 
        or state.PetStyleCycle.value:lower() == "dd" 
        or state.PetModeCycle.value:lower() == "dd" 
        or state.PetStyleCycle.value:lower() == "bone") and not
